...
async def best_repo(interaction: discord.Interaction, user: str = "tot0p"):
    ...
    embed.set_author(name=user, url=bestRepo["owner"]["html_url"], icon_url=bestRepo["owner"]["avatar_url"])
